...
use CustomerRecipe as CustomerRecipeModel; 
use DB;

class RecipeApplyController extends \BaseController {
    ...
    public function index() {
        ...
        $param['applications'] = CustomerRecipeModel::paginate(10);

        
        $param['pageNo'] = 9;
        
	    return View::make('admin.recipeApply.index')->with($param);
	}
	...
	public function create() {
	    ...
	    return View::make('admin.recipeApply.create')->with($param);
	}
	...
	public function edit($id) {
	    ...
	    return View::make('admin.recipeApply.edit')->with($param);
	}
	...
	public function store() {
	    ...
	    if ($validator->fails()) {
	        ...
	        return Redirect::route('admin.recipeApply')->with('alert', $alert);	        
	    }
	}
