...
<main class="bs-docs-masthead gray-container" role="main">
    ...
    <div class="container">
		...
		<div class="col-sm-3">
			...
			<div class="row margin-top-lg div-gray-box">
				...
				<div class="col-sm-12 margin-top-normal">
					<div class="col-sm-6">
						<img style="width: 80px; height: 80px; border-radius: 5px;" src="{{ HTTP_PHOTO_PATH.$user[0]->profile_image }}">
					</div>
					<div class="col-sm-6">
						<div class="row">
						...
						<div class="row">
							<a href="{{ URL::route('user.view', $user[0]->id) }}" style="font-size: 20px;">{{ $user[0]->name }}</a>
						</div>
					</div>
				</div>
		...
		<div class="col-sm-2">
			<!-- Div for Profile -->
			<!-- Div for My Jobs -->
			<a href="/customer/chat/<?php echo $user[0]->id;?>" class="btn btn-sm btn-danger">
                    <span class="glyphicon glyphicon-edit"></span> Chat
			</a>
