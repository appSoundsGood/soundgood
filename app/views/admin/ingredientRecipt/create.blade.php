...
<div class="portlet box blue">
    ...
    <div class="portlet-body">
        <form class="form-horizontal" role="form" method="post" action="{{ URL::route('admin.ingredientRecipt.store') }}" enctype="multipart/form-data">
           
           
          <div class="form-group">
              <label class="col-sm-2 control-label">Ingredient</label>
              <div class="col-sm-6">    
                   <select class="form-control" name="ingredientId" id = "sel">
          ...
          <input type="hidden" class="form-control" name="reciptId" value="{{$reciptId}}">
